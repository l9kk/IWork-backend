...
from app.schemas.integrations import StockDataResponse, HistoricalStockDataResponse, TaxDataResponse
...
def get_tax_api_service(redis: RedisClient = Depends(get_redis)):
    ...
    return TaxAPIService(redis_client=redis, alpha_vantage_api_key=alpha_vantage_api_key)
