...
async def search_reviews(
    ...
    """
    Full-text search for reviews with additional filters
    """
    ...
    reviews, total_count = SearchService.search_reviews(
        db, query, company_id, min_rating, max_rating, skip, limit
    )
